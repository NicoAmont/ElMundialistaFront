...
export default function WebsiteelmundialistaOnePage() {
  ...
  return (
    <>
      ...
      <div className="w-full bg-white-A700_01">
        <div>
          <div className="flex h-[888px] items-start justify-between gap-5 bg-[url(/public/images/img_frame_28.png)] bg-cover bg-no-repeat py-[39px] md:h-auto md:flex-col md:pt-0 sm:py-5">
            <div className="mb-[63px] flex w-[93%] flex-col items-end gap-[107px] md:mb-auto md:w-full md:gap-20 md:p-5 sm:w-[Auto%] sm:gap-[53px]">
              ...
              <div className="flex w-[92%] items-center justify-between gap-5 md:w-full md:flex-col md:gap-[86px] sm:gap-[63px]">
                <div className="flex w-[49%] flex-col items-start gap-[18px] md:w-[71%] sm:w-[302px] sm:gap-[15px]">
                  ...
                  <Text as="p" className="w-full leading-[25px]">
                    <>
                      ...
                      <br />
                      Inscripciones nuevas cada semana y siempre hay espacio para el deporte.
                    </>
                  </Text>
                ...
                <div className="flex w-[41%] flex-col items-center gap-4 md:w-full">
                  <div className="w-full max-w-[474px] self-stretch rounded-lg">
                    <Slider
                      autoPlay
                      ...
                      items={[...Array(6)].map(() => (
                        <React.Fragment key={Math.random()}>
                          <Img src="images/img_rectangle_47.png" alt="image" className="h-[193px] object-cover" />
                        </React.Fragment>
                      ))}
                    />
                  </div>
              ...
              <div className="flex items-center justify-between gap-5 self-stretch md:flex-col">
                <div className="flex h-[60px] w-[30%] items-start justify-center bg-[url(/public/images/img_frame_25.svg)] bg-cover bg-no-repeat p-[5px] md:h-auto md:w-full">
                  <Heading
                    size="lg"
                    as="h4"
                    className="mr-[23px] self-end !font-oswald uppercase !text-white-A700_01 md:mr-0"
                  >
                    TORNEOS EN ESPERA
                  </Heading>
                </div>
                <div className="flex w-[63%] gap-[59px] md:w-full md:flex-row md:items-center md:justify-center sm:w-[237px] sm:flex-col">
                  {data2.map((d, index) => (
                    <div
                      key={"listunirme" + index}
                      className="flex w-full flex-col gap-2.5 rounded-lg bg-white-A700_7f p-5 md:w-[240px] md:items-center sm:w-full"
                    >
                      <div className="flex items-center gap-6">
                        <Img src={d.image} alt="image" className="h-[73px] w-[60%]" />
                        <Heading
                          size="2xl"
                          as="h5"
